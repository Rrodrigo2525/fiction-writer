...
export default function Editor({ title, setTitle, description, setDescription, cancelStory, saveStory, deleteStory }) {
    ...
    const conflicts = ['indivíduo contra indivíduo', 'indivíduo contra natureza', 'indivíduo contra si mesmo',
        'indivíduo contra destino/sorte', 'indivíduo contra máquina', 'indivíduo contra sistema', 'indivíduo contra passado'];
    ...
    const ambients = ['escola', 'empresa', 'cidade pequena', 'cidade grande', 'comunidade rural', 'presídio', 'hospital', 'floresta'];
    ...
    return (
        <div className="editor">
            ...
            <p>{`Escreva uma história com um(a) protagonista "${hero}"com um conflito do tipo "${conflict}" do gênero "${genre}"
            ambientada em um(a) "${ambient}" no tempo "${time}" para o público "${audience}". ${additional}.`}</p>
